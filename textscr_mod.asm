...
ScrollFont		db	"Lucida Console",0
ScrollText	    		db	"PERYFERiAH tEAM present an SHA-1 keygen for Iperius Backup 7.5.5                                                "
						...
						db  "tools , trainingcircle.in , tuts4you.org and revteam.re communities "
						db  "! :3)                                                               "
						db  "Look for more details either on PRF.nfo or .... idfk , just email us"
						db  " or even contact us through discord ffs .. :E                                          "
						db  "ALL ALGOZ ARE ONLY MADE FOR TESTIN` & EDUCATIONAL PURPOSES , MADE WITH"
						db  " MY HANDY REVERSIN` SKILLZ WITH OLLYDBG AND KEYGENER ASSISTANT AS LONG"
						db  " AS THEY`RE MADE FOR PRACTICIN` CRYPTO-KEYGENNING , DON`T U EVEN THINK" 
						db  " I RIPPED/STOLE THESE ALGOS CUZ IM NOT MART!K PANOSIAN !                 "
						db  "                                thanx 4 ur attention ^)                  ",0
