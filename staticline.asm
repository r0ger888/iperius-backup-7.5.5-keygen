...
loc_402DB7:           
            ...
            ;    invoke SetPixel,BoxDC,esi,edi,0FFFFFFh ; 0000FFFFh <-- text line down color
                pop     ecx
                loop    loc_402DB7
                invoke BitBlt,hDCC,xLinePos,yLinePos,LineWidth,LineHeight,BoxDC,0,0,0CC0020h
                invoke Sleep,5 ; <-- scroller speed
                dec     [x]
                mov     eax, [x]
                neg     eax
                cmp     eax, [var_45]
